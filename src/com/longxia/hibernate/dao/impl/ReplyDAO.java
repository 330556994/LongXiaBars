...
import com.longxia.entities.Reply;

/**
 	* A data access object (DAO) providing persistence and search support for Reply entities.
...
public class ReplyDAO extends BaseHibernateDAO  {
    ...
    public Reply findById( java.lang.Integer id) {
        ...
        try {
            Reply instance = (Reply) getSession()
                    .get("Reply", id);
            return instance;
        } catch (RuntimeException re) {
